...
public class randomPosition : MonoBehaviour {
    ...
    void OnEnable(){
        ...
        if (selectedSession == 0) {
            ...
            path0[0] = new Vector3(0.2887f, 0.0f, 0.5f) + newOrgio;        //H: +30°   //V: +0°
            path0[1] = new Vector3(-0.1444f, -0.1444f, 0.5f) + newOrgio;   //H: -45°   //V: -15°
            path0[2] = new Vector3(-0.5774f, 0.0f, 0.5f) + newOrgio;       //H: -45°   //V: +15°
            path0[3] = new Vector3(0.5774f, 0.7218f, 0.5f) + newOrgio;     //H: +120°  //V: +75°
            path0[4] = new Vector3(0.7218f, 0.5774f, 0.5f) + newOrgio;     //H: +15°   //V: -15°
            path0[5] = new Vector3(0.5774f, -0.5774f, 0.5f) + newOrgio;    //H: -15°   //V: -120°
            path0[6] = new Vector3(-0.2887f, -0.5774f, 0.5f) + newOrgio;   //H: -90°   //V: +0°
            path0[7] = new Vector3(-0.1444f, 0.1444f, 0.5f) + newOrgio;    //H: +15°   //V: +75°
            path0[8] = new Vector3(0.0f, 0.0f, 0.5f) + newOrgio;           //H: +15°   //V: -15°
            ...
            //path0 turned 180°
            path1[0] = new Vector3(-0.2887f, 0.0f, 0.5f) + newOrgio;       //H: -30°   //V: +0°
            path1[1] = new Vector3(0.1444f, 0.1444f, 0.5f) + newOrgio;     //H: +45°   //V: +15°
            path1[2] = new Vector3(0.5774f, 0.0f, 0.5f) + newOrgio;        //H: +45°   //V: -15°
            path1[3] = new Vector3(-0.5774f, -0.7218f, 0.5f) + newOrgio;   //H: -120°  //V: -75°
            path1[4] = new Vector3(-0.7218f, -0.5774f, 0.5f) + newOrgio;   //H: -15°   //V: +15°
            path1[5] = new Vector3(-0.5774f, 0.5774f, 0.5f) + newOrgio;    //H: +15°   //V: +120°
            path1[6] = new Vector3(0.2887f, 0.5774f, 0.5f) + newOrgio;     //H: +90°   //V: +0°
            path1[7] = new Vector3(0.1444f, -0.1444f, 0.5f) + newOrgio;    //H: -15°   //V: -75°
            path1[8] = new Vector3(0.0f, 0.0f, 0.5f) + newOrgio;           //H: -15°   //V: +15°
            ...
            //path0 backwards
            path2[0] = new Vector3(-0.1444f, 0.1444f, 0.5f) + newOrgio;    //H: -15°   //V: +15°
            path2[1] = new Vector3(-0.2887f, -0.5774f, 0.5f) + newOrgio;   //H: -15°   //V: -75°
            path2[2] = new Vector3(0.5774f, -0.5774f, 0.5f) + newOrgio;    //H: +90°   //V: 0°
            path2[3] = new Vector3(0.7218f, 0.5774f, 0.5f) + newOrgio;     //H: +15°   //V: +120°
            path2[4] = new Vector3(0.5774f, 0.7218f, 0.5f) + newOrgio;     //H: -15°   //V: +15°
            path2[5] = new Vector3(-0.5774f, -0.0f, 0.5f) + newOrgio;      //H: -120°  //V: -75°
            path2[6] = new Vector3(-0.1444f, -0.1444f, 0.5f) + newOrgio;   //H: +45°   //V: -15°
            path2[7] = new Vector3(0.2887f, 0.0f, 0.5f) + newOrgio;        //H: +45°   //V: +15°
            path2[8] = new Vector3(0.0f, 0.0f, 0.5f) + newOrgio;           //H: -30°   //V: 0°
